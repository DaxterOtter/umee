...
type MsgSwapResponse struct {
	...
	Returned types.Coin `protobuf:"bytes,3,opt,name=returned,proto3" json:"returned"`
}
...
func (m *MsgSwapResponse) GetFee() types.Coin {
	if m != nil {
		return m.Fee
	}
	return types.Coin{}
...
type MsgRedeemResponse struct {
	...
	Received types.Coin `protobuf:"bytes,3,opt,name=received,proto3" json:"received"`
}
...
func (m *MsgRedeemResponse) GetFee() types.Coin {
	if m != nil {
		return m.Fee
	}
	return types.Coin{}
...
type MsgGovUpdateRegistry struct {
	...
	// update_index defines the new settings for existing index.
	DeleteAsset []AssetToDelete `protobuf:"bytes,6,rep,name=delete_asset,json=deleteAsset,proto3" json:"delete_asset"`
}
...
// AssetToDelete is an accepted asset to be deleted from an Index. After the deletion the asset cannot be swapped or
// redeemed by the Index meToken.
type AssetToDelete struct {
	MetokenDenom string `protobuf:"bytes,1,opt,name=metoken_denom,json=metokenDenom,proto3" json:"metoken_denom,omitempty"`
	DeleteAsset  string `protobuf:"bytes,2,opt,name=delete_asset,json=deleteAsset,proto3" json:"delete_asset,omitempty"`
}

func (m *AssetToDelete) Reset()         { *m = AssetToDelete{} }
func (m *AssetToDelete) String() string { return proto.CompactTextString(m) }
func (*AssetToDelete) ProtoMessage()    {}
func (*AssetToDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_4fa56b8f5850b02d, []int{8}
}
func (m *AssetToDelete) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AssetToDelete) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AssetToDelete.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AssetToDelete) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetToDelete.Merge(m, src)
}
func (m *AssetToDelete) XXX_Size() int {
	return m.Size()
}
func (m *AssetToDelete) XXX_DiscardUnknown() {
	xxx_messageInfo_AssetToDelete.DiscardUnknown(m)
}

var xxx_messageInfo_AssetToDelete proto.InternalMessageInfo

func (m *AssetToDelete) GetMetokenDenom() string {
	if m != nil {
		return m.MetokenDenom
	}
	return ""
...
func (m *AssetToDelete) GetDeleteAsset() string {
	if m != nil {
		return m.DeleteAsset
	}
	return ""
}
...
func init() {
	...
	proto.RegisterType((*AssetToDelete)(nil), "umeenetwork.umee.metoken.v1.AssetToDelete")
}
...
var fileDescriptor_4fa56b8f5850b02d = []byte{
	...
	,
}
...
func (this *MsgGovUpdateRegistry) Equal(that interface{}) bool {
	...
	if len(this.DeleteAsset) != len(that1.DeleteAsset) {
		return false
	}
	for i := range this.DeleteAsset {
		if !this.DeleteAsset[i].Equal(&that1.DeleteAsset[i]) {
			return false
		}
	}
	return true
...
func (m *MsgGovUpdateRegistry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DeleteAsset) > 0 {
		for iNdEx := len(m.DeleteAsset) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DeleteAsset[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AssetToDelete) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AssetToDelete) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AssetToDelete) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.DeleteAsset) > 0 {
		i -= len(m.DeleteAsset)
		copy(dAtA[i:], m.DeleteAsset)
		i = encodeVarintTx(dAtA, i, uint64(len(m.DeleteAsset)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.MetokenDenom) > 0 {
...
func (m *AssetToDelete) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgGovUpdateRegistry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteAsset", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeleteAsset = append(m.DeleteAsset, AssetToDelete{})
			if err := m.DeleteAsset[len(m.DeleteAsset)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AssetToDelete) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AssetToDelete: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AssetToDelete: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.DeleteAsset = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
